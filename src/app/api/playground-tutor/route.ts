...
- Hash type: ${ctx.hashType || "MD5"}
- Attack mode: ${ctx.attackMode || "Straight"}
- Wordlist: ${ctx.wordlist || "rockyou.txt"}
- Rules: ${ctx.rules || "none"}
- Mask: ${ctx.mask || "n/a"}
- Recovered password: ${ctx.recovered || "pending"}
...
Focus on Hashcat methodology, password security principles, and educational best practices. Never provide guidance on attacking real systems or real credentials — this is a safe educational environment only.`;
